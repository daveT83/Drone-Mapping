...
def main():
    ...
    #matrix = findAllMissing(matrix)
    writeBack(matrix,interval)
...
def writeBack(matrix,interval):
    ...
    it = str(getIteration())
    newFile = "./Do Nothing/3D Latitudes(" + it + ").txt"
    ...
    newFile = "./Do Nothing/3D Longitudes(" + it + ").txt"
    ...
    newFile = "./Do Nothing/3D Matrix(" + it + ").txt"
    i = 0
...
def getIteration():
    filePath = "./Do Nothing/Iteration.txt"
    iteration = 0
